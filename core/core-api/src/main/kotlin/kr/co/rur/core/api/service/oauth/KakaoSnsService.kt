...
import kr.co.rur.core.api.model.oauth.conf.AuthConfig
import kr.co.rur.core.api.model.oauth.model.AuthToken
import kr.co.rur.core.api.model.oauth.model.KakaoResponseWrapper
import kr.co.rur.core.api.support.utils.HttpClientUtils
...
class KakaoSnsService(
    ...
    fun getUserInfo(authToken: AuthToken?): KakaoResponseWrapper? {
        ...
        val mapper = ObjectMapper()
        val response: String = kr.co.rur.core.api.support.utils.HttpClientUtils.doGet(
            profileUrl,
